...
public class CompuTestMsg {
	...
	public Boolean getHasExamRoom() {
		// 如果examRoom和seatNumber都有值，则认为已分配考场
		return examRoom != null && !examRoom.isEmpty() && 
			   seatNumber != null && !seatNumber.isEmpty();
	}

	public void setHasExamRoom(Boolean hasExamRoom) {
		this.hasExamRoom = hasExamRoom;
	}
	...
	public String toString() {
		return "CompuTestMsg [cid=" + cid + ", sname=" + sname + ", epicture=" + epicture + ", sclass=" + sclass
				...
				+ ", tename=" + tename + ", nocontent=" + nocontent + ", cstatus=" + cstatus + ", examRoom=" + examRoom
				+ ", seatNumber=" + seatNumber + ", examDate=" + examDate + ", examTime=" + examTime + "]";
	}
